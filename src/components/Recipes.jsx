...
const Recipes = () => {
  ...
  return (
    <div className="w-full">
      ...
      {recipes?.length > 0 ? (
        <>
          <div className="w-full  flex flex-col justify-center gap-10 px-0 sm:flex-row sm:flex-wrap lg:px-10 py-10">
            ...
            {/* Extra cards */}
            <div className="w-full h-0 sm:w-1/3 md:w-1/4 lg:w-1/5"></div>
            <div className="w-full h-0 sm:w-1/3 md:w-1/4 lg:w-1/5"></div>
            <div className="w-full h-0 sm:w-1/3 md:w-1/4 lg:w-1/5"></div>
          </div>
